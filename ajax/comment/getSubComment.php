...
if (isset($_POST['parent_id'], $_POST['product_id'], $_POST['reply_id'])) {
    $id = $_POST['product_id'];
    $id_parent = $_POST['parent_id'];
    $reply_id = $_POST['reply_id'];

    // truy vấn
    $queryGetSubComment = "SELECT * FROM comment WHERE id = $reply_id";
    $resultGetSubComment = $conn->query($queryGetSubComment);
    $ReplyComment = $resultGetSubComment->fetch_assoc();
}
?>
<!-- respone -->
                        ...
                        <li>
                            <div class="d-flex align-items-center form-main-comment">
                                ...
                                <form action="javascript:void(0)" method="POST">
                                    <input type="text" class="comment-input reply-<?php echo $parent_id ?> " name="<?php echo $parent_id; ?>" value="<?php echo $ReplyComment['content'] ?>">
                                    <input type="submit" class="reply-update d-none" name="<?php echo $id; ?>,<?php echo $parent_id; ?>,<?php echo $reply_id; ?>">
                                </form>
                            </div>
                        </li>
                <?php
