...
if (isset($_POST['product_id'], $_POST['parent_id'], $_POST['content'], $_POST['reply_id'])) {
    ...
    $queryUpdateComment = "UPDATE comment SET content = '{$content}', updated_at = '{$datetime}' WHERE id = {$reply_id}";
