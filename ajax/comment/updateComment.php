...
if (isset($_POST['product_id'], $_POST['user_id'], $_POST['parent_id'], $_POST['content'])) {
    $content = $_POST['content'];
    $id = (int)$_POST['product_id'];
    $user_id = (int)$_POST['user_id'];
    $id_comment = (int)$_POST['parent_id'];

    // truy vấn
    date_default_timezone_set('Asia/Ho_Chi_Minh');
    $datetime = date('Y:m:d H:i:s');
    $queryUpdateComment = "UPDATE comment SET content = '{$content}', updated_at = '{$datetime}' WHERE id = {$id_comment}";
    $resultUpdateComment = $conn->query($queryUpdateComment);
}
?>
<!--  respone -->
