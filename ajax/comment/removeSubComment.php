...
if (isset($_POST['product_id'], $_POST['parent_id'], $_POST['reply_id'])) {
    $id = $_POST['product_id'];
    $parent_id = $_POST['parent_id'];
    $reply_id = $_POST['reply_id'];
    // truy vấn
    $queryDelSubComment = "DELETE FROM comment WHERE id = {$reply_id}";
    $resultDelSubComment = $conn->query($queryDelSubComment);
}
?>
<!-- respone -->
<?php
