        ...
        <div class="container bg-white p-0">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <?php
                    //Tổng số dòng
                    $qrTsd = "SELECT * FROM category WHERE parent_id IS NULL";
                    ...
                    <!--end pagination -->
                    <?php
                    $queryGetCategory = "SELECT id,name FROM category WHERE parent_id IS NULL ORDER BY id DESC LIMIT {$offset},{$row_count}";
